      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden">
        ...
        <div className="p-5 border-b border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/50 flex flex-col sm:flex-row gap-4 items-center justify-between">
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto justify-end">
            <label htmlFor="participants-view-status" className="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Health Status:</label>
            <select
              id="participants-view-status"
              value={statusFilter}
