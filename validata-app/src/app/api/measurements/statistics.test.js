...
describe('aggregateByParticipant', () => {
  it('averages multiple sessions for the same participant', () => {
    const data = [
      { participantId: 'P-1', date: '2026-05-02', aiAngle: 10, goniometerAngle: 12 },
      { participantId: 'P-1', date: '2026-05-01', aiAngle: 20, goniometerAngle: 20 },
      { participantId: 'P-2', date: '2026-05-01', aiAngle: 5, goniometerAngle: 5 },
    ];
    ...
    expect(p1.date).toBe('2026-05-01'); // keeps earliest date
...
describe('calculateDescriptiveStats', () => {
  ...
  it('computes mean/sd/se across participant errors', () => {
    ...
    expect(stats.mean).toBeCloseTo(0); // (+2, -2) averages to 0
...
describe('calculatePassRate', () => {
  it('classifies measurements within/outside the threshold', () => {
    const data = [
      { aiAngle: 10.5, goniometerAngle: 10 }, // diff 0.5, passes at threshold 1
      { aiAngle: 15, goniometerAngle: 10 },   // diff 5, fails at threshold 1
    ];
